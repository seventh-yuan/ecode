/**
  ...
  *@version     V1.0.0
  *@date        2017/11/4
  *@brief       This module is used to calculate and check crc16.
  *******************************************************
  */
...
static const kl_u16_t crc16tab[256]= {
...
{
    kl_u16_t crc = crc16_ccitt((const kl_u8_t *)buf, len);
    if(crc == tcrc)
        return 1;
    else
        return 0;
